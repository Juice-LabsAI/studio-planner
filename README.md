...
- **Timeline key:** click the ⓘ button in the Schedule toolbar for the key — bar shapes (project / deliverable on its own dates / deliverable following the project), priority colours, and what the overflow and capacity warnings mean.
